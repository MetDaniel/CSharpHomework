...
namespace program2
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            orders.Add(new OrderDetails("1996-12-10-012", "韩梅梅","12345678910", "肥皂", 200));
            orders.Add(new OrderDetails("1999-11-02-021", "李雷","10987654321", "香皂", 10001));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            obj2.ShowDialog();
            os.AddOrder(orders, obj2.text1(), obj2.text2(), obj2.text5(), obj2.text3(), double.Parse(obj2.text4()));
